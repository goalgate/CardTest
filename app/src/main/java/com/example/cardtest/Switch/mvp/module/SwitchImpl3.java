 ...
 */
public class SwitchImpl3 implements ISwitching {
    ...
    private byte[] readerbuffer = new byte[100];
                ...
                try {
                    ...
                    if (size >= 9) {
                        ...
                        if (testStr.contains("AAAAAA")) {
                            testStr = testStr.substring(testStr.indexOf("AAAAAA"), testStr.indexOf("AAAAAA") + 18);
                        } else if (testStr.contains("BBBBBB")) {
                            testStr = testStr.substring(testStr.indexOf("BBBBBB"), testStr.indexOf("BBBBBB") + 18);
