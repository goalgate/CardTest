...
public class MaiChongSwitchImpl implements ISwitching {
    ...
    private byte[] dt_greenLightBlink = { 0x02, 0x02, 0x03, 0x00,
            (byte) 0x0B, 0x01, 0x01, (byte) 0xD1, (byte) 0x92};
    private byte[] dt_redLightBlink = { 0x02, 0x02, 0x03, 0x00,
            (byte) 0x0B, 0x02, 0x02, (byte) 0x91, (byte) 0x63};
    private byte[] dt_whiteLightOn = { 0x02, 0x02, 0x03, 0x00, (byte) 0x0A,
            0x01, 0x01, (byte) 0x80, 0x52};
    private byte[] dt_whiteLightOff = { 0x02, 0x02, 0x03, 0x00, (byte) 0x0A
            , 0x01, 0x00, (byte) 0x41, (byte) 0x92};
