        ...
        public void run() {
            ...
            while (thread_continuous) {
                try {
                    ...
                    Lg.e("testStrsize", String.valueOf(size));
                    ...
                    Lg.e("testStr", testStrTemp);
//                    if (size >= 9) {
//                        if (testStr.contains("AAAAAA")) {
//                            testStr = testStr.substring(testStr.indexOf("AAAAAA"), testStr.indexOf("AAAAAA") +
//                                    18);
//                            Lg.e("testStrSuccess", testStr);
//                            mhandler.sendEmptyMessage(0x123);
//
//                        }
//                        if (testStr.contains("BBBBBB")) {
//                            testStr = testStr.substring(testStr.indexOf("BBBBBB"), testStr.indexOf("BBBBBB") +
//                                    18);
...
//                                sw_temp = testStr;
                    ...
                    Lg.e("bufCount", String.valueOf(bufCount));
...
//
//                    for (int i = 0; i < size; i++) {
//                        testStr += byteToHex(by_copy[i]);
//                    }
//
//                    Lg.e("testStr", testStr);
//
//                    if (size >= 9) {
//                        if (testStr.contains("AAAAAA")) {
//                            testStr = testStr.substring(testStr.indexOf("AAAAAA"), testStr.indexOf("AAAAAA") +
...
//                            bufCount = 0;
//                            testStrTemp += testStr;
//                            if (testStrTemp.contains("AAAAAA")) {
//                                testStrTemp = testStrTemp.substring(testStrTemp.indexOf("AAAAAA"),
//                                        testStrTemp.indexOf("AAAAAA") + 18);
//                                Lg.e("testStrSuccess", testStrTemp);
//                                mhandler.sendEmptyMessage(0x123);
//
//                            }
//                            if (testStrTemp.contains("BBBBBB")) {
//                                testStrTemp = testStrTemp.substring(testStrTemp.indexOf("BBBBBB"),
//                                        testStrTemp.indexOf("BBBBBB") + 18);
//                                temperature = (int) hexStr2Bytes(testStrTemp.substring(10, 12))[0];
//                                humidity = (int) hexStr2Bytes(testStrTemp.substring(6, 8))[0];
//                                mhandler.sendEmptyMessage(0x234);
//                            }
//                            testStrTemp = "";
//                        } else {
...
//    }
    ...
    //                    Thread.sleep(500);
    //                    int size = switch_InputStream.read(readerbuffer);
    //                    Lg.e("size",String.valueOf(size));
    //                    byte[] by_copy = new byte[size];
    //                    System.arraycopy(readerbuffer, 0, by_copy, 0, size);
    //                    if (size >= 9) {
    //                        testStr = "";
    //                        for (int i = 0; i < size; i++) {
    ...
    // 18);
    //                        }
    ////                        } else if (testStr.contains("BBBBBB")) {
    ////                            testStr = testStr.substring(testStr.indexOf("BBBBBB"), testStr.indexOf("BBBBBB")
    // + 18);
    ////                            temperature = (int) hexStr2Bytes(testStr.substring(10,12))[0];
    ////                            humidity = (int) hexStr2Bytes(testStr.substring(6,8))[0];
